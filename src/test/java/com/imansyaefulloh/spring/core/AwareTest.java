...
import com.imansyaefulloh.spring.core.service.AuthService;
...
public class AwareTest {
    ...
    void testAware() {
        ...
        Assertions.assertEquals("com.imansyaefulloh.spring.core.service.AuthService", authService.getBeanName());
